...
```{r, include=FALSE}
# Behavioural results
ppt_details_change <- read.csv('/Users/hwillis_admin/Desktop/PostDocs/Projects/Rehab_Project/MRI/Diffusion/Manuscripts/reviews/share_data/all_behaviour_Feb24.csv')
...
# Diffusion change
change_all <- read.csv("/Users/hwillis_admin/Desktop/PostDocs/Projects/Rehab_Project/MRI/Diffusion/Manuscripts/reviews/share_data/change_all.csv")
change_all_distal <- read.csv("/Users/hwillis_admin/Desktop/PostDocs/Projects/Rehab_Project/MRI/Diffusion/Manuscripts/reviews/share_data/change_all_distal.csv")

# Full tract for hMT+ 
hMT_fulltract_data_trained_only <- read.csv("/Users/hwillis_admin/Desktop/PostDocs/Projects/Rehab_Project/MRI/Diffusion/Manuscripts/reviews/share_data/hMT_fulltract_data_trained_only.csv")

# Distal dLGN for all timepoints 
hMT_distal_data_alltime <- read.csv("/Users/hwillis_admin/Desktop/PostDocs/Projects/Rehab_Project/MRI/Diffusion/Manuscripts/reviews/share_data/hMT_distal_data_alltime.csv")

# Distal dLGN in sighted field after training
combined_df <- read.csv("/Users/hwillis_admin/Desktop/PostDocs/Projects/Rehab_Project/MRI/Diffusion/Manuscripts/reviews/share_data/combined_df.csv")
...
# Split into each tract of interest
all_diff$sessionID <- factor(all_diff$sessionID, levels = c("notrain", "baseline", "6month"))

vpl <- all_diff[grepl("vpl", all_diff$structureID),]
v1 <- all_diff[grepl("v1", all_diff$structureID),]
hMT <- all_diff[!grepl("vpl|v1", all_diff$structureID),]
